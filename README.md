...
_This console application where the Sphinx asks a riddle and the you must answer the riddle correctly. If the riddle is answered correctly, the Sphinx asks a second riddle and so on.
